package com.adityaagusw.notifforlarast.notification
...
import com.adityaagusw.notifforlarast.MainActivity
import com.adityaagusw.notifforlarast.R
import java.util.*
...
class ReminderBroadcast : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, p1: Intent?) {
        showDailyNotif(context, "ini adalah notifikasi", "ini pesan message", NOTIF_ID)
    }
